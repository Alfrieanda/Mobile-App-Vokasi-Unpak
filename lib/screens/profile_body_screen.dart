              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('065120050', style: vkTextCardBold),
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('Strata 1 (S1)', style: vkTextCardBold),
                  ],
                ),
              ],
            ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Alfrieanda', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color(0xffee8303)),
          Padding(
            padding: const EdgeInsets.only(left: 12.0, right: 12.0),
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Nanda', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color(0xffee8303)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Perum. Cikeas Permai Blok B-15 Rt01/14 Gunung Putri, Bogor, Indonesia',
